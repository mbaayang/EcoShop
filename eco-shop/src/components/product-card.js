...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="group relative">
      ...
      >
        {isWishlisted ? (
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4 lg:w-6 lg:h-6 text-orange-400">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 lg:w-6 lg:h-6">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 016.364 0L12 7.682l1.318-1.364a4.5 4.5 0 016.364 6.364l-7.071 7.071a.25.25 0 01-.354 0l-7.071-7.071a4.5 4.5 0 010-6.364z" />
          </svg>
        )}
      </button>
